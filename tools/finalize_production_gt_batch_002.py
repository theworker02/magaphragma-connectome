"""QC-finalize PRODUCTION_GT_BATCH_002; promote only if frozen QC gates pass."""
...
BATCH = REPO / "experiments/phase6e/PRODUCTION_GT_BATCH_002.json"
...
def main() -> int:
    ...
    if batch.get("qc") or batch.get("promotion"):
        raise SystemExit("Already QC/promoted")
    if PROMOTED.exists():
        raise SystemExit(f"Exists: {PROMOTED}")
    ...
    if all_pass:
        ...
        batch["promotion"] = {
            ...
            "batch_001_permanently_excluded": True,
        }
        promoted = {
            "id": "PRODUCTION_GT_PROMOTED_BATCH_002",
            "schema_version": 1,
            "status": "PRODUCTION_GT_PROMOTED",
            "created_at": _now(),
            "source_batch": "PRODUCTION_GT_BATCH_002",
            ...
            "training": {
                ...
                "permanently_excluded_artifacts": [
                    ...
                    "experiments/phase6e/PRODUCTION_GT_BATCH_001.json",
                    "experiments/phase6e/PRODUCTION_GT_BATCH_001_FAILED_CANDIDATE.json",
                ],
            },
        }
        ...
        batch["gt_status"] = (
            "CANDIDATE_PRODUCTION_GT_QC_FAILED" if complete else "CANDIDATE_PRODUCTION_GT_INCOMPLETE"
        )
